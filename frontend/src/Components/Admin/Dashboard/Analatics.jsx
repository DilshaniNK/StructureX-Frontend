            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="text-left text-gray-300 py-3 px-4">Project</th>
                  <th className="text-left text-gray-300 py-3 px-4">Planned (Days)</th>
                  <th className="text-left text-gray-300 py-3 px-4">Actual (Days)</th>
                  <th className="text-left text-gray-300 py-3 px-4">Variance</th>
              ...
              <tbody>
                {projectTimelineData.map((project, index) => (
                  <tr key={index} className="border-b border-gray-700 hover:bg-gray-700/30">
                    <td className="py-3 px-4 text-white">{project.project}</td>
                    <td className="py-3 px-4 text-gray-300">{project.planned}</td>
                    <td className="py-3 px-4 text-gray-300">{project.actual}</td>
                    <td className="py-3 px-4">
                      <span className={`${project.status === 'ahead' ? 'text-green-400' : 'text-red-400'}`}>
                        {project.status === 'ahead' ? '-' : '+'}
                        {Math.abs(project.actual - project.planned)} days
                      </span>
                    </td>
                    <td className="py-3 px-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        ...
                        {project.status === 'ahead' ? 'Ahead' : 'Delayed'}
                      </span>
                    </td>
                  </tr>
                ))}
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            {alerts.map((alert, index) => (
              <div key={index} className={`border-l-4 ${getAlertBorderColor(alert.type)} bg-gray-700/30 p-4 rounded-r-lg`}>
