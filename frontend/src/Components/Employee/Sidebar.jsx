    ...
    <>
      ...
      >
              ...
              return (
                <div key={item.id} className="relative group">
                  ...
                  >
                    ...
                    <div className={`absolute left-0 top-1/2 transform -translate-y-1/2 w-1 h-6 bg-[#FAAD00] rounded-r-full transition-all duration-300 ${
                    ...
                    <div className={`flex items-center ${!isExpanded ? 'justify-center w-full' : ''}`}>
                      ...
                      <span className={`font-semibold text-xs lg:text-sm whitespace-nowrap transition-all duration-300 ${
                        isExpanded ? 'opacity-100 translate-x-0 block' : 'opacity-0 -translate-x-4 w-0 overflow-hidden hidden lg:block'
                      }`}>
                        {item.label}
                      </span>
                    </div>
                    ...
                    {isExpanded && (
                      <div className="flex items-center space-x-2">
                        {item.badge && (
                          <span className={`px-2.5 py-1 text-xs font-bold rounded-full transition-all duration-300 shadow-sm ${
                            isActive
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-gray-100 shadow-lg">
          ...
          {/* Version Footer */}
          <div className={`p-2 lg:p-4 bg-gradient-to-r from-gray-50 via-gray-50/80 to-transparent transition-all duration-300 ${
            (isDesktopHovered || isSidebarOpen) ? 'opacity-100 block' : 'opacity-0 hidden lg:block'
          }`}>
