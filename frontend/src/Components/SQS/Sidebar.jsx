...
const Sidebar = ({ 
  ...
  const menuItems = {
    SQSOfficer: [      { id: 'home', label: 'Home', icon: Home, path: '/sqs', badge: null },
  ...
  const currentMenu = menuItems.SQSOfficer;
  ...
  const getRoleTitle = (role) => {
    const titles = {
      ...
      SQSOfficer: 'Senior QS Officer Portal',
    };
