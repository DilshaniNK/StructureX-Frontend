...
export default function ProcessModal({ projectId, onClose, onUploaded, user }) {

  // projectId is provided via props
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Posting legal process payload:', payload);

      await axios.post(`http://localhost:8086/api/v1/legal_officer/add_legal_process`, payload, {
